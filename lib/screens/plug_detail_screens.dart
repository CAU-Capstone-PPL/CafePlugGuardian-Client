                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          TitleText(
                                              content:
                                                  '${context.watch<PlugDetailProvider>().plug!.usedPower.toStringAsFixed(1)} / ${context.watch<PlugDetailProvider>().plug!.assignPower.toStringAsFixed(1)}'),
                                        ],
                                      )
                                    ],
                                  ),
